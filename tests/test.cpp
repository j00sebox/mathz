...
TEST_CASE("Matrix Transpose", "[matrix 4x4]")
{
	...
	mathz::Mat4 result = orig.transpose();
...
TEST_CASE("Matrix Subtraction", "[matrix 4x4]")
{
	...
	mathz::Mat4 expected_subtraction(
...
TEST_CASE("Matrix-Matrix Multiplication", "[matrix 4x4]")
{
	...
	mathz::Mat4 expected_multiplication(
...
TEST_CASE("Matrix-Vector Multiplication", "[matrix 4x4]")
{
	...
	mathz::Vec3 expected_multiplication(
		 0.725589810365f,
		-0.274276447894f,
		-0.801733441565f
	);

	mathz::Vec3 result = a * b;
